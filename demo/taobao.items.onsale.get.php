...
/* 得到当前会话用户出售中的商品列表 Start*/
	...
	$paramArr = array(
		...
		/* API系统级输入参数 Start */
	    	...
	    	'method' => 'taobao.items.onsale.get',  //API名称
...
?>
    ...
    <tr>
      <td colspan="8" bgcolor="#FFFFFF"><input type="submit" value="搜索" >
      </td>
    <tr>
    </table>
</form>
...
<table border="0" width="100%" class="table">
  ...
  <tr>
    ...
    <td><a href="taobao.item.update.delisting.php?num_iid=<?php echo $item['num_iid'];?>" target="_blank">宝贝下架</a></td>
  </tr>  
  <?php
	}else{
  ...
  ?>
  <tr>
    <td><?php echo $val['has_showcase'];?></td>
    ...
    <td><a href="taobao.item.update.delisting.php?num_iid=<?php echo $val['num_iid'];?>" target="_blank">宝贝下架</a></td>
  </tr>
  <?php
  }
  }
